---
title: "Vision Transformer (ViT) Explained: An Image is Worth 16x16 Words"
subtitle: Transformers for Image Recognition at Scale with PyTorch Implementation
description: | 
...
In this blog post, we would not only be looking at the architectures in detail, but we will also understand how they are implemented in [timm](https://github.com/rwightman/pytorch-image-models), thus, looking at the code implementation too! 

And also please welcome [Dr Habib Bukhari](https://twitter.com/dr_hb_ai)! You might know of him as [DrHB](https://www.kaggle.com/drhabib) on Kaggle - at the time of writing, ranked **186/154,204** on the Kaggle ranking system! I am sure we all knew that he is great at deep learning but did you also know that he can also do some kickass visualizations to explain complicated concepts easily? And that, we have decided to team up for this and many more future blog posts to explain the concepts in an easy and visual manner. Together, we hope that you like what you read and see! Much effort and planning has gone into writing this blog post.
