...
### Public Kernels
Chris Deotte's [kernel](https://www.kaggle.com/cdeotte/triple-stratified-kfold-with-tfrecords) used TPUs and was one of the best Public kernel for this competition. We re-trained 4 different models of varying image sizes that were part of the final ensemble. 
